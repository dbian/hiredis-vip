...
OBJ=alloc.o net.o hiredis.o sds.o async.o read.o hiarray.o hiutil.o command.o crc16.o adlist.o sockcompat.o hircluster.o
SSL_OBJ=ssl.o
...
TESTS=hiredis-test
LIBNAME=libhiredis_ys
PKGCONFNAME=libhiredis_ys.pc
SSL_LIBNAME=liblibhiredis_ys_ssl
SSL_PKGCONFNAME=libhiredis_ys_ssl.pc

HIREDIS_MAJOR=$(shell grep HIREDIS_MAJOR hircluster.h | awk '{print $$3}')
HIREDIS_MINOR=$(shell grep HIREDIS_MINOR hircluster.h | awk '{print $$3}')
HIREDIS_PATCH=$(shell grep HIREDIS_PATCH hircluster.h | awk '{print $$3}')
HIREDIS_SONAME=$(shell grep HIREDIS_SONAME hircluster.h | awk '{print $$3}')

# Installation related variables and target
PREFIX?=/usr/local
INCLUDE_PATH?=include/hiredis_ys
LIBRARY_PATH?=lib
